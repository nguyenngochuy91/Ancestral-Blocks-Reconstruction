...
```
B. The user can provide his/her own set of bacteria species in genbank format. Preferably, the user should download all the available bacterial genomes from the NCBI website. The ftp link for that is [ftp://ftp.ncbi.nih.gov/genomes/archive/old_refseq/Bacteria/all.gbk.tar.gz](ftp://ftp.ncbi.nih.gov/genomes/archive/old_refseq/Bacteria/all.gbk.tar.gz). (about 30GB) 
